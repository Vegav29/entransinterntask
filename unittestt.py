...
class TestSummaryWithPickle(unittest.TestCase):
    ...
    def test_total_row_count(self):
        """Test that the number of rows matches the expected count."""
        self.assertGreater(len(self.data), 0, "Row count should be greater than zero.")
        print(f"Row count: {len(self.data)}")
